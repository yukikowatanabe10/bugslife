...
public class TaxAmountController {
	...
	public String index(Model model) {
		...
		model.addAttribute("taxAmounts", taxAmounts);
		return "taxAmount/index";
	}

	@GetMapping(value = "/new")
	public String create(Model model, @ModelAttribute TaxAmountForm taxAmountForm) {
		model.addAttribute("taxAmount", new TaxAmountForm());
		return "taxAmount/form";
	}

	@PostMapping
	public String create(@ModelAttribute TaxAmountForm taxAmountForm) {
		this.taxamountService.save(taxAmountForm);
	...
	public String delete(@PathVariable("id") Long id) {
		this.taxamountService.delete(id);
		return "redirect:/taxAmount";
	}
